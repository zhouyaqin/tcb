...
var config = {
    ...
    lineType: 'broken' //broken-折线 curve-曲线
};
                ...
                if (opts.extra.lineStyle === 'curve') {
                    points.forEach(function (item, index) {
                        if (index > 0) {
                            ...
                            var lineType = opts.lineType || 'broken'; //修改 line 类型 展示直线（broken）或曲线（curve）
                            if (lineType == 'broken') {
                              context.lineTo(item.x, item.y);//直线
                            } else if (lineType == 'curve') {
                              context.bezierCurveTo(ctrlPoint.ctrA.x, ctrlPoint.ctrA.y, ctrlPoint.ctrB.x, ctrlPoint.ctrB.y, item.x, item.y); //曲线
                            }//修改 line 类型 展示直线（broken）或曲线（curve）
            ...
            if (points.length === 1) {
                ...
                if (opts.extra.lineStyle === 'curve') {
                    points.forEach(function (item, index) {
                        if (index > 0) {
                            var ctrlPoint = createCurveControlPoints(points, index - 1);
                            var lineType = opts.lineType || 'broken';
                            if (lineType == 'broken') {
                              context.lineTo(item.x, item.y);
                            } else if (lineType == 'curve') {
